...
document.getElementById("lname").required = false;
	...
	function Weekly(){
monthlyDIV.style.display = 'none';
document.getElementById("payment_interval").value = "ongoing";
...
document.getElementById("monthitem").disabled = false;
}
	
	function Fortnightly(){
monthlyDIV.style.display = 'none';
document.getElementById("payment_interval").value = "ongoing";
document.getElementById("frequency").value = "Fortnightly";
anonymousDIV.style.display = 'none';
contactDIV.style.display = 'inline';
document.getElementById("fname").required = true;
document.getElementById("lname").required = true;
...
<?php echo $parish_church_name ?></h2>
                                         ...
                                         <li class="nav-item"><a class="nav-link mb-sm-3 mb-md-0" data-toggle="tab" onClick="Weekly()">Weekly</a></li>
											   <li class="nav-item"><a class="nav-link mb-sm-3 mb-md-0" data-toggle="tab" onClick="Fortnightly()">Fortnightly</a></li>
...
<h6>Monthly payments are deducted on the 1st of each month</h6>
 ...
 <input name="payment_interval" id="payment_interval" type="hidden" value="onetime">
													<input name="frequency" id="frequency" type="hidden">
                                                <div class="nav-wrapper position-relative"><ul class="nav nav-pills nav-fill flex-column flex-sm-row">
                                          <li class="nav-item"><a class="nav-link mb-sm-3 mb-md-0 active" onClick="Amount10()" data-toggle="tab" href="">$10</a></li>
                                           <li class="nav-item"><a class="nav-link mb-sm-3 mb-md-0" onClick="Amount25()" data-toggle="tab" href="">$25</a></li>
                                            <li class="nav-item"><a class="nav-link mb-sm-3 mb-md-0" onClick="Amount50()" data-toggle="tab" href="#">$50</a></li>
                                          <li class="nav-item"><a class="nav-link mb-sm-3 mb-md-0" onClick="AmountOther()" data-toggle="tab" href="#">Other</a></li></ul>
                                          </div>
...
$sql = "SELECT * FROM intentions WHERE parish = " . $_SESSION['parishid'] ;  
$result = $conn->query($sql);
